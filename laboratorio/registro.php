                                    ...
                                    <div class="card-body">
                                        <form  name="nuevopaciente" action="guardar.php" method="POST">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-2" id="inputFirstName" name="nombre" type="text" placeholder="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputLastName">Apellido</label>
                                                        <input class="form-control py-2" id="inputLastName" name="apellido" type="text" placeholder="" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control " id="inputEmailAddress" name="correo" type="email" aria-describedby="emailHelp" placeholder="/>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="id">Numero de Cedula</label>
                                                    <input class="form-control" id="id" name="cedula" type="text" aria-describedby="" placeholder=""/>
                                                </div>
                                           </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="age" name="edad" type="number" placeholder="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-13">
                                                ...
                                                <input class="form-control" id="direccion" name="direccion" rows="3" placeholder=""></input>
                                            </div>
                                            <div class="col-md-13">
                                                <div class="form-group">
